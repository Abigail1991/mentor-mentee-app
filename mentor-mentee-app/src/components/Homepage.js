    ...
    <div className="p-4 bg-white">
      ...
      <section className="mb-8 text-center">
        ...
        <div className="border p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 inline-block">
          <p className="text-lg"><FaBullseye className="inline mr-2" /> Our mission is to empower individuals by fostering meaningful mentor-mentee relationships that drive personal and professional growth. We aim to provide an accessible, user-friendly platform where mentors and mentees can connect, share knowledge, and develop their skills in a supportive environment.</p>
        </div>
      </section>
      <section className="mb-8 text-center">
        <h2 className="text-3xl font-bold mb-4">Vision</h2>
        <div className="border p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 inline-block">
          <p className="text-lg"><FaEye className="inline mr-2" /> Our vision is to become the leading platform for mentoring, where every individual has the opportunity to benefit from the guidance and support of a mentor. We strive to create a global community that values continuous learning, collaboration, and the development of future leaders.</p>
        </div>
      </section>
      <section className="mb-8 text-center">
        ...
        <div className="border p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 inline-block">
          <TransitionGroup component="ul" className="list-disc list-inside text-left mx-auto max-w-md">
            <CSSTransition key={sharedValues[index].id} timeout={500} classNames="fade">
              <li className="my-2">{sharedValues[index].icon}{sharedValues[index].text}</li>
            </CSSTransition>
          </TransitionGroup>
        </div>
      </section>
